...
$template = $twig->loadTemplate('db-accountPostingSplit.twig');
...
$js[] = '/js/table.accountPostingSplit.js';

echo $template->render(array(
    'pageTitle' => 'Account Posting Split',
    'pageHeading' => 'Account Posting Split',
    'user' => $user,
    'addCss' => $css,
    'addJs' => $js,
));